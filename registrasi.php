			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-12 col-md-12 col-lg-8">
						...
						<p class="subheading text-left">Form Registrasi</p>
						<form   action="simpan_registrasi.php" method="POST" class="form-contact">
							<div class="row">
								...
								<div class="col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="nama_pasien" class="form-control" placeholder="Nama Lengkap"  required="" autocomplete="off">
										<div class="help-block with-errors"></div>
								...
								<div class="col-sm-6 col-md-6">
									<select class="select2 form-control select2" name="jenis_kelamin" data-placeholder="Jenis Kelamin" required="">
								...
								<div class="col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="alamat" class="form-control" id="p_subject" placeholder="Alamat" autocomplete="off">
										<div class="help-block with-errors"></div>
									</div>
								</div>
