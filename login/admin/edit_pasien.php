                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-8">
                                            ...
                                            <h4 class="header-title m-t-0">Edit Pasien</h4>
                                           
                                            <div class="p-20">
                                                <form  method="POST" action="code/simpan_edit_pasien.php">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" readonly="" name="no_rm" parsley-trigger="change" required
                                                               placeholder="No R.M" class="form-control" id="userName" value="<?php echo $data['no_rm']; ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_pasien" parsley-trigger="change" required
                                                               placeholder="Nama Lengkap" class="form-control" id="userName" value="<?php echo $data['nama_pasien']; ?>">
                                                    </div>
