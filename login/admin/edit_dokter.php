                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-8">
                                            ...
                                            <h4 class="header-title m-t-0">Edit Dokter</h4>
                                           
                                            <div class="p-20">
                                                <form  method="POST" action="code/simpan_edit_dokter.php">

                                                    <?php
                                                        $sql = mysql_query("SELECT * FROM dokter 
                                                            JOIN poli ON dokter.kode_poli=poli.kode_poli WHERE nik_dokter='$_GET[nik_dokter]'"); 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nik_dokter" parsley-trigger="change" required
                                                               placeholder="NIK" class="form-control" id="userName" value="<?php echo $data['nik_dokter']; ?>">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="userName">Nama Lengkap<span class="text-danger">*</span></label>
                                                        <input type="text" name="nama_dokter" parsley-trigger="change" required
                                                               placeholder="Nama Lengkap" class="form-control" id="userName" value="<?php echo $data['nama_dokter']; ?>">
                                                    </div>
                                                    ...
                                                    <label for="userName">Jenis Kelamin<span class="text-danger">*</span></label><br>
                                                     ...
                                                     <div class="form-group">
                                                        <label for="userName">Spesialis Poli<span class="text-danger">*</span></label>
