                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-8">
                                            ...
                                            <h4 class="header-title m-t-0">Data Poli</h4>
                                           
                                            <div class="p-20">
                                                <form  method="POST" action="code/simpan_poli.php">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_poli" parsley-trigger="change" required
                                                               placeholder="Nama Poli" class="form-control" id="userName">
                                                    </div>
