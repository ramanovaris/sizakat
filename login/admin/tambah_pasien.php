...
$q = "SELECT max(no_rm) as maxKode FROM pasien";
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Tambah Pasien - RSIA</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="header-title m-t-0">Tambah Pasien Baru</h4>
                                           
                                    <div class="p-20">
                                    <form  method="POST" action="code/simpan_pasien.php">
                                        <div class="form-group">
                                        <label for="userName">NIK<span class="text-danger">*</span></label>
                                        <input type="text" name="nik" parsley-trigger="change" required placeholder="NIK" class="form-control" id="userName">
                                        </div>

                                        <div class="form-group">
                                        <label for="userName">No R.M<span class="text-danger">*</span></label>
                                        <input type="text" readonly="" value="<?php echo $newID; ?>" name="no_rm" parsley-trigger="change" required placeholder="No R.M" class="form-control" id="userName">
                                        </div>

                                                    <div class="form-group">
                                                        <label for="userName">Nama Lengkap<span class="text-danger">*</span></label>
                                                        <input type="text" name="nama_pasien" parsley-trigger="change" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="alamat" parsley-trigger="change" required
                                                               placeholder="Alamat" class="form-control" id="userName">
                                                    </div>
