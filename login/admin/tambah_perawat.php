...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Tambah Perawat - RSIA</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Tambah Perawat</h4>
                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-8">
                                            ...
                                            <h4 class="header-title m-t-0">Data Perawat</h4>
                                           
                                            <div class="p-20">
                                                <form  method="POST" action="code/simpan_perawat.php">
