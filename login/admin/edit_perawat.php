                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Edit Perawat</h4>
                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-8">
                                            ...
                                            <h4 class="header-title m-t-0">Edit Perawat</h4>
                                           
                                            <div class="p-20">
                                                <form  method="POST" action="code/simpan_edit_perawat.php">

                                                    <?php
                                                        $sql = mysql_query("SELECT * FROM perawat WHERE nik_perawat='$_GET[nik_perawat]'"); 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nik_perawat" parsley-trigger="change" required
                                                               placeholder="NIK" class="form-control" id="userName" value="<?php echo $data['nik_perawat']; ?>">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="userName">Nama Lengkap<span class="text-danger">*</span></label>
                                                        <input type="text" name="nama_perawat" parsley-trigger="change" required
                                                               placeholder="Nama Lengkap" class="form-control" id="userName" value="<?php echo $data['nama_perawat']; ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="jabatan" parsley-trigger="change" required
                                                               placeholder="Jabatan" class="form-control" id="userName" value="<?php echo $data['jabatan']; ?>">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="userName">Alamat<span class="text-danger">*</span></label>
                                                        <input type="text" name="alamat" parsley-trigger="change" required
                                                               placeholder="Jabatan" class="form-control" id="userName" value="<?php echo $data['alamat']; ?>">
                                                    </div>
