...
$simpan_rm = mysql_query("INSERT INTO rekam_medis VALUES('','$nik_petugas','$nik_dokter','$nik_perawat','$kode_poli','$no_rm','$tanggal', NULL, 'Sedang Dipinjam','$jaminan','$jenis_perawatan')")or die(mysql_error());
