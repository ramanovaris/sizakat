                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                                            ...
                                            <div class="p-20">
                                                <form  method="POST" action="code/simpan_pesan_kamar.php">
                                                    ...
                                                    <?php
                                                        ...
                                                        $kota = mysql_query("SELECT pasien.no_rm, pasien.nama_pasien, rekam_medis.jenis_perawatan FROM `pasien` JOIN rekam_medis ON pasien.no_rm=rekam_medis.no_rm WHERE rekam_medis.jenis_perawatan = 'Rawat Inap'");
                            ...
                            <input type="text" class="form-control" autocomplete="off" placeholder="mm/dd/yyyy" name="tgl_pesan" id="tgl_pesan">
