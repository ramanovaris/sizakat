    ...
    $data = mysql_fetch_array($sql);
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="date" class="form-control" placeholder="mm/dd/yyyy" id="tgl_pesan" name="tgl_pesan" readonly="" value="<?php echo $data['tgl_pesan']; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <div class="input-group">
                                                                ...
                                                                <input onchange="counthari()" readonly="" type="text" class="form-control" placeholder="" name="tgl_keluar" id="tgl_keluar" required="">
