...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Profil Petugas - RSIA</title>
                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-8">
                                            ...
                                            <h4 class="header-title m-t-0">Profil Petugas</h4>
                                           
                                            <div class="p-20">
                                                <form  method="POST" action="code/simpan_profil.php">

                                                    <?php
                                                        $sql = mysql_query("SELECT * FROM petugas WHERE kode_akun='$kode_akun'"); 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" readonly="" name="nik_petugas" parsley-trigger="change" required
                                                    ...
                                                    <label for="userName">Jenis Kelamin<span class="text-danger">*</span></label><br>
                                                        <div class="radio radio-info radio-inline" >
                                                            <input type="radio"  id="inlineRadio1" value="Laki-laki" name="jenis_kelamin" readonly="" <?php if($jk=="Laki-laki"){echo "checked";}?>>
                                                            <label for="inlineRadio1">Laki-laki</label>
                                                        </div>
                                                        <div class="radio radio-inline">
                                                            <input type="radio"  id="inlineRadio2" value="Perempuan" name="jenis_kelamin" readonly="" <?php if($jk=="Perempuan"){echo "checked";}?>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" readonly="" name="jabatan" parsley-trigger="change" required
